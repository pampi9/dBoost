...
results = {"gaussian": [], "mixture": [], "histogram": []}
...
for train, test in itertools.product(train_sizes, test_sizes):
    ...
    for e in experiments:
        ...
        if e[1] == "gaussian":
            ...
            cmd = "./dboost-stdin.py -m --pr 100000 --minimal -F ' ' --train-with {} {} --statistical {} --{} {} -d fracpart -d unix2date_float > /tmp/tmp.out 2>{}".format(
                *([train_file] + [test_file] + e + [f])
            )
        elif e[1] == "mixture":
